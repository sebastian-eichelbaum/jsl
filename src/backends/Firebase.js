...
import { getDownloadURL, getStorage, uploadBytes, deleteObject, ref } from "firebase/storage";
...
export class FirestoreService extends DatabaseService {
    ...
    /**
     * Implements the deleteDoc functionality as described in @see DatabaseService.deleteDoc
     */
...
export class FirebaseStorage extends StorageService {
     ...
     */
    async _upload(path, fileBlob) {
        return uploadBytes(path, fileBlob).then((snapshot) => {
